...
import { teamCreateCommandDef, teamDisbandCommandDef, teamJoinCommandDef, teamKickCommandDef, teamListCommandDef, teamPendingCommandDef, teamViewCommandDef } from '@/modules/team/adapters/team.command.js'
